      ...
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="POST">
          <div class="form-group">
            ...
            <span class="invalid-feeback"><?php echo $data['name_error']; ?></span>
          </div>
          <div class="form-group">
            ...
            <span class="invalid-feeback"><?php echo $data['email_error']; ?></span>
          </div>
          <div class="form-group">
            ...
            <span class="invalid-feeback"><?php echo $data['password_error']; ?></span>
          </div>
          <div class="form-group">
            <label for="confirm_password">Confirm Password: <sup>*</sup></label>
            <input type="password" name="confirm_password" class="form-control form-control-lg <?php echo (!empty($data['confirm_passwoed_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['confirm_password']; ?>">
            <span class="invalid-feeback"><?php echo $data['confirm_password_error']; ?></span>
          </div>
          <div class="row">
